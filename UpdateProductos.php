...
echo "Los datos actualizados son los siguientes: <br>";
echo "$IDProducto, $Descripcion, $Marca, $Cantidad";

var_dump('check');

$conectar = conn(); //ejecuta las conexiones a la bd Y aqui fue donde lenin le cambio 
$sql = "UPDATE productos SET Descripcion='$Descripcion', Marca='$Marca', Cantidad='$Cantidad', Precio='$Precio' WHERE IDProducto=$IDProducto";
